...
Currently doesn't include a gitlab pages deployment workflow.

## Environment variables

GitHub Actions sets the GitHub variables. For a local build, or for a
GitLab repository, you must set them yourself. GitLab needs both
...
| `CI_PROJECT_PATH` | GitLab project path (`group/project`, subgroups included). | |
| `CI_SERVER_HOST` | GitLab instance host. | |
| `CI_DEFAULT_BRANCH` | GitLab default branch. | `main` |
